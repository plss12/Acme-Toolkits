	...
	<tr>
		<th scope="row">
			...
			<table class="table table-sm" id="id-averageBudgetOfCHIMPUM">
				...
				<jstl:forEach items="${chimpumCurrency}" var="chimpumCurrency">
					<tr>
						<th scope="row"><acme:print value="${chimpumCurrency}"/></th>
						<jstl:set value="${averageBudgetOfCHIMPUM.entrySet().stream().filter(x->x.getKey().equals(chimpumCurrency)).iterator()}" var="entrySet"/>
						<jstl:if test="${entrySet.hasNext()}">
							<jstl:forEach items="${entrySet}" var="entry">
								<th scope="row"><acme:print value="${entry.getValue()}" /></th>
							</jstl:forEach>
		...
		<th scope="row">
			...
			<table class="table table-sm" id="id-deviationBudgetOfCHIMPUM">
				...
				<jstl:forEach items="${chimpumCurrency}" var="chimpumCurrency">
					<tr>
						<th scope="row"><acme:print value="${chimpumCurrency}"/></th>
						<jstl:set value="${deviationBudgetOfCHIMPUM.entrySet().stream().filter(x->x.getKey().equals(chimpumCurrency)).iterator()}" var="entrySet"/>
						<jstl:if test="${entrySet.hasNext()}">
							<jstl:forEach items="${entrySet}" var="entry">
								<th scope="row"><acme:print value="${entry.getValue()}"/></th>
							</jstl:forEach>
		...
		<th scope="row">
			...
			<table class="table table-sm" id="id-minimumBudgetOfCHIMPUM">
				...
				<jstl:forEach items="${chimpumCurrency}" var="chimpumCurrency">
					<tr>
						<th scope="row"><acme:print value="${chimpumCurrency}"/></th>
						<jstl:set value="${minimumBudgetOfCHIMPUM.entrySet().stream().filter(x->x.getKey().equals(chimpumCurrency)).iterator()}" var="entrySet"/>
						<jstl:if test="${entrySet.hasNext()}">
							<jstl:forEach items="${entrySet}" var="entry">
								<th scope="row"><acme:print value="${entry.getValue()}"/></th>
							</jstl:forEach>
		...
		<th scope="row">
			...
			<table class="table table-sm" id="id-maximumBudgetOfCHIMPUM">
				...
				<jstl:forEach items="${chimpumCurrency}" var="chimpumCurrency">
					<tr>
						<th scope="row"><acme:print value="${chimpumCurrency}"/></th>
						<jstl:set value="${maximumBudgetOfCHIMPUM.entrySet().stream().filter(x->x.getKey().equals(chimpumCurrency)).iterator()}" var="entrySet"/>
						<jstl:if test="${entrySet.hasNext()}">
							<jstl:forEach items="${entrySet}" var="entry">
								<th scope="row"><acme:print value="${entry.getValue()}"/></th>
							</jstl:forEach>
