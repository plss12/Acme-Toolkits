...
<acme:list>
	<acme:list-column code="any.artifact.list.label.name" path="artifact.name"/>	
	<acme:list-column code="any.artifact.list.label.retailPrice" path="artifact.retailPrice"/>
